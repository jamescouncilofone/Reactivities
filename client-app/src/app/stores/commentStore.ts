...
export default class CommentStore {
    ...
    createHubConnection = (activityId: string) => {
        if (store.activityStore.selectedActivity) {
            ...
            this.hubConntection.start().catch(error => console.log('Error establishing the connection: ', error));
    ...
    stopHubConnection = () => {
        this.hubConntection?.stop().catch(error => console.log('Error stopping connection: ', error));
    }
